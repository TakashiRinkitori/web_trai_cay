...
<head>
    ...
    <title>Admin PT Fruit - Thương hiệu trái cây số 1 Việt Nam</title>
...
<body id="page-top">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Coppyright©2023 | Designed by Rinkitori</span>
                    </div>
                </div>
            </footer>
        </div>
    ...
    <!-- Sweetalert -->
    <script src="{{asset('server/js/sweetalert.js')}}"></script>
    ...
    <!-- ckeditor -->
    <script src="{{asset('server/ckeditor/ckeditor.js')}}"></script>
    <script type="text/javascript">
