...
<head>
    ...
    <!-- Light Slider -->
    <link rel="stylesheet" href="{{asset('client/css/lightgallery.min.css')}}">
    <link rel="stylesheet" href="{{asset('client/css/prettify.css')}}">
...
<body>
    ...
    <header class="mb-3 fixedElement">
        ...
        <div class="wrapper-top py-1">
            <div class="container">
                <div class="detail">
                    <a class="map-top" href="https://www.google.com/maps/place/Tr%C6%B0%E1%BB%9Dng+%C4%90%E1%BA%A1i+h%E1%BB%8Dc+C%C3%B4ng+ngh%E1%BB%87+Giao+th%C3%B4ng+V%E1%BA%ADn+t%E1%BA%A3i/@20.984792,105.7962517,922m/data=!3m2!1e3!4b1!4m6!3m5!1s0x3135acc6bdc7f95f:0x58ffc66343a45247!8m2!3d20.984792!4d105.798832!16s%2Fg%2F1pznmrlzr"><i class="fas fa-map-marker-alt"></i> Địa chỉ: Phố Triều Khúc - Quận Hà Đông - Tp Hà Nội |</a>
                    <a href="tel: 0123 456 789"><i class="m-lg-1 fas fa-phone-alt"></i> 0123 456 789</a>
                </div>
                <div class="social">
                    Social:
        ...
        <div class="container-fluid pb-3 header-pc">
            <div class="row">
                <a class="col-sm-1" href="{{url('/')}}" title="PT Fruit - Thương hiệu trái cây số 1 Việt Nam">
                    <img src="{{url('client/img/logo.png')}}" alt="PT Fruit - Thương hiệu trái cây số 1 Việt Nam" width="192" height="68">
                </a>
                <div class="col-sm-2">
                    <div class="row">
                        ...
                        <div class="col-md-9 mt-3">
                            ...
                            <a class="item-row2 text-danger" href="tell: 0123 456 789">0123 456 789</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <div class="col-md-2 mt-4"><img src="{{url('client/img/icon-conversion.png')}}" alt="icon-conversion"></div>
                ...
                <div class="col-sm-4">
                    <div class="row">
                        <div class="col-md-2 mt-4"><img src="{{url('client/img/icon-product.png')}}" alt="icon-product"></div>
                        <div class="col-md-10 mt-3">
                ...
                <div class="col-sm-2 row mt-3">
                    ...
                    <div class="col-md-6 icon-search">
                        <img src="{{url('client/img/icon-search.png')}}" width="44" alt="Search">
        ...
        <div class="nav-responsive">
            <div class="logo-homepage">
                <a class="icon-logo" href="{{url('/')}}" title="PT Fruit - Thương hiệu trái cây số 1 Việt Nam">
                    <img src="{{url('client/img/logo-mobile.png')}}" alt="PT Fruit - Thương hiệu trái cây số 1 Việt Nam">
                </a>
            </div>
            <div class="nav-wrapper-res">
                ...
                <div class="show-nav-res js-nav-social">
                    <ul class="nav-row row js-row-social">
                        ...
                        <li class="col-md-5 nav-row-item">
                            <a href="tel: 0123 456 789">0123 456 789 (giờ hành chính)</a>
                        </li>
                        <li class="col-md-10 nav-row-item">
                            <a href="mailto: minhhieupck1@gmail.com">minhhieupck1@gmail.com</a>
                        </li>
                    </ul>
                </div>
    ...
    <footer>
        <div class="footer">
            <div class="container">
                <div class="row mx-0">
                    <div class="col-md-5">
                        <p>
                            <a href="{{url('/')}}"><img class="mb-3 logo-footer" src="{{url('client/img/logo-mobile.png')}}" alt="PT Fruit - Thương hiệu trái cây số 1 Việt Nam"></a> <br>
                            <i class="mr-3 fas fa-map-marked-alt"></i>Cơ sở 1 <br>
                            <span>&emsp;&emsp;<i class="mr-3 fas fa-map-marker-alt"></i>Địa chỉ:<a class="row-bottom-2" href="https://goo.gl/maps/nAevBeFZNkUMMpv7A"> Triều Khúc, Q. Thanh Xuân, TP. Hà Nội</a></span><br>
                            ...
                            <span>&emsp;&emsp;<i class="mr-3 fas fa-envelope"></i>Email:<a class="row-bottom-2" href="mailto: minhhieupck1@gmail.com"> minhhieupck1@gmail.com</a></span>
                        </p>
                        <p>
                            <i class="mr-3 fas fa-map-marked-alt"></i>Cơ sở 2 <br>
                            <span>&emsp;&emsp;<i class="mr-3 fas fa-map-marker-alt"></i>Địa chỉ:<a class="row-bottom-2" href="https://goo.gl/maps/nAevBeFZNkUMMpv7A"> Triều Khúc, Q. Thanh Xuân, TP. Hà Nội</a></span><br>
                            <span>&emsp;&emsp;<i class="mr-3 fas fa-phone-alt"></i>Điện thoại:<a class="row-bottom-2" href="tel: 0123 456 789"> 0123 456 789</a></span><br>
                            <span>&emsp;&emsp;<i class="mr-3 fas fa-envelope"></i>Email:<a class="row-bottom-2" href="mailto: minhhieupck1@gmail.com"> minhhieupck1@gmail.com</a></span>
                        </p>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row container">
                    ...
                    <div class="col-md-6 copyright">Coppyright©2023 PT Fruit | Designed by Minh</div>
                </div>
            </div>
        </div>
        <div class="row-bottom">
            <div class="row">
                <div class="col-md-2">
                    <span class="row-bottom-1">Mua hàng:<a class="row-bottom-2" href="tel: 0123 456 789"> 0123 456 789</a></span>
                </div>
                <div class="col-md-3">
                    <span class="row-bottom-1">Hotline:</span>
                    <a class="row-bottom-2" href="tel: 0123 456 789"> 0123 456 789</a>
                    <span> (giờ hành chính)</span>
                </div>
                <div class="col-md-3">
                    <span class="row-bottom-1">Email:</span>
                    <a class="row-bottom-2" href="mailto: minhhieupck1@gmail.com"> minhhieupck1@gmail.com</a>
                </div>
            </div>
        </div>
    </footer>
    ...
    <!-- Light Slider -->
    <script type="text/javascript" src="{{asset('client/js/lightgallery-all.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('client/js/lightslider.js')}}"></script>
    <script type="text/javascript" src="{{asset('client/js/prettify.js')}}"></script>
