                ...
                <div class="wrap-product row">
                    <div class="col-sm-12 col-md-5 p-4">
                        <ul id="imageGallery">
                            ...
                            <li data-thumb="{{url('uploads/gallery/'.$gal->gallery_image)}}" data-src="{{url('uploads/gallery/'.$gal->gallery_image)}}">
                                <img src="{{url('uploads/gallery/'.$gal->gallery_image)}}" alt="{{$gal->gallery_name}}" width="100%">
                            </li>
                            @endforeach
                        </ul>
                    </div>
            ...
            <div class="product-contact">
                <div class="text-center mb-3">
                    <div style="color: #fff;" class="title-content">
                        <img src="{{url('client/img/dot-title-left.png')}}" alt=""> Bình luận đánh giá <img src="{{url('client/img/dot-title-right.png')}}" alt="">
                    </div>
                </div>
