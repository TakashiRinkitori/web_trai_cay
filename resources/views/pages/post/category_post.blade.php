    ...
    <div class="row">
        <div class="text-center mb-3">
            <a class="title-content" href="#">
                <img src="{{url('client/img/dot-title-left.png')}}" alt=""> {{$cate->cate_post_name}} <img src="{{url('client/img/dot-title-right.png')}}" alt="">
            </a>
        </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-6 px-2">
                <div class="box-product text-center">
                    <a href="{{url('bai-viet/'.$pos->post_slug)}}">
                        <img style="border-radius: 8px;" src="{{url('uploads/post/'.$pos->post_image)}}" height="240px" alt="{{$pos->post_title}}">
                    </a>
