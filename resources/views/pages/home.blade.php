    ...
    <div class="row">
        <div class="text-center mb-3">
            <a class="title-content" href="{{url('/danh-muc-san-pham/'.$cate_pro->category_id)}}">
                <img src="{{url('client/img/dot-title-left.png')}}" alt=""> {{$cate_pro->category_name}} <img src="{{url('client/img/dot-title-right.png')}}" alt="">
            </a>
    ...
    <div class="row">
        <div class="text-center mb-3">
            <a class="title-content" href="{{url('/danh-muc-san-pham/30')}}">
                <img src="{{url('client/img/dot-title-left.png')}}" alt=""> Trái cây Việt <img src="{{url('client/img/dot-title-right.png')}}" alt="">
            </a>
                ...
                <div class="box-product">
                    <form>
                        ...
                        <a href="{{url('chi-tiet-san-pham/'.$viet->product_id)}}">
                            <img src="{{url('uploads/product/'.$viet->product_image)}}" width="100%" alt="{{$viet->product_name}}">
                        </a>
                        <div class="info-product text-center">
    ...
    <div class="row">
        <div class="text-center mb-3">
            <a class="title-content" href="{{url('/danh-muc-san-pham/27')}}">
                <img src="{{url('client/img/dot-title-left.png')}}" alt=""> Trái cây Minh Phương <img src="{{url('client/img/dot-title-right.png')}}" alt="">
            </a>
                ...
                <div class="box-product">
                    <form>
                        ...
                        <a href="{{url('chi-tiet-san-pham/'.$minh_pphuong->product_id)}}">
                            <img src="{{url('uploads/product/'.$minh_pphuong->product_image)}}" width="100%" alt="{{$minh_pphuong->product_name}}">
                        </a>
                        <div class="info-product text-center">
    ...
    <div class="row">
        <div class="text-center mb-3">
            <a class="title-content" href="{{url('/danh-muc-san-pham/23')}}">
                <img src="{{url('client/img/dot-title-left.png')}}" alt=""> Giỏ quà cao cấp <img src="{{url('client/img/dot-title-right.png')}}" alt="">
            </a>
                ...
                <div class="box-product">
                    <form>
                        ...
                        <a href="{{url('chi-tiet-san-pham/'.$gio_qua->product_id)}}">
                            <img src="{{url('uploads/product/'.$gio_qua->product_image)}}" width="100%" alt="{{$gio_qua->product_name}}">
                        </a>
                        <div class="info-product text-center">
    ...
    <div class="row">
        <div class="text-center mb-3">
            <a class="title-content" href="{{url('/danh-muc-san-pham/24')}}">
                <img src="{{url('client/img/dot-title-left.png')}}" alt=""> Hộp quà cao cấpt <img src="{{url('client/img/dot-title-right.png')}}" alt="">
            </a>
                ...
                <div class="box-product">
                    <form>
                        ...
                        <a href="{{url('chi-tiet-san-pham/'.$hop_qua->product_id)}}">
                            <img src="{{url('uploads/product/'.$hop_qua->product_image)}}" width="100%" alt="{{$hop_qua->product_name}}">
                        </a>
                        <div class="info-product text-center">
...
<div class="wrap-banner">
    <div class="wrap-img text-center">
        <img src="{{url('client/img/banner-img.png')}}" alt="PT Fruit" title="PT Fruit - Thương hiệu trái cây số 1 Việt Nam">
    </div>
    <div class="container text-center">
        <div class="title-content">
            <img src="{{url('client/img/dot-title-left.png')}}" alt=""> PT Fruit - Fresh fruit & organic food <img src="{{url('client/img/dot-title-right.png')}}" alt=""></div>
        <div class="descript-introduce">
            <ol>
                ...
                <li>&emsp;Ở Hà Nội bạn không biết nơi nào bán trái cây SẠCH và AN TOÀN với giá cả hợp lý và chất lượng hết?</li>
        ...
        <div class="wrap-program">
            <div class="col-md-6"><img src="{{url('client/img/banner-logo.png')}}" width="100%" alt="FT Fruit" title="PT Fruit - Thương hiệu trái cây Việt Nam"></div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="rotate-y mt-4 text-center">
                    <a href="#"><img src="{{url('client/img/food-safety.png')}}" alt="An toàn thực phẩm"></a>
                </div>
            ...
            <div class="frame-message">
                <div class="text-center mb-2">
                    <div class="title-content mb-0">
                        <img src="{{url('client/img/dot-title-left.png')}}" alt=""> Liên hệ với chúng tôi <img src="{{url('client/img/dot-title-right.png')}}" alt=""></div>
...
<div class="wrap-news">
    <div class="container text-center">
        <div class="title-content">
            <img src="{{url('client/img/dot-title-left.png')}}" alt=""> Tin tức - Video <img src="{{url('client/img/dot-title-right.png')}}" alt=""></div>
    </div>
    <div class="row">
        <div class="col-xs 12 col-md-6 list-new mb-4">
            ...
            <div class="box-new clearfix">
                <a href="{{url('bai-viet/'.$pos->post_slug)}}">
                    <img src="{{url('uploads/post/'.$pos->post_image)}}" width="270px" alt="{{$pos->post_title}}">
                </a>
                <div class="info-new">
        ...
        <div class="col-xs 12 col-md-5">
            <ul id="imageGallery">
                ...
                <li data-thumb="{{url('uploads/video_image/'.$vid->video_image)}}" data-src="{{url('public/uploads/video_image/'.$vid->video_image)}}">
...
<div class="wrap-partner">
    <div class="text-center mb-3">
        <div class="title-content">
            <img src="{{url('client/img/dot-title-left.png')}}" alt=""> Đối tác - Khách hàng <img src="{{url('client/img/dot-title-right.png')}}" alt="">
        </div>
    </div>
